...
echo mode con:cols=18 lines=2 > %temp%\temp.bat
echo set startup=%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup >> %temp%\temp.bat
...
echo powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/symbuzzer/Turkish-Ad-Hosts/main/windows/turkish-ad-hosts-windows.bat' -OutFile '%startup%\turkish-ad-hosts-windows.bat'" >> %temp%\temp.bat
