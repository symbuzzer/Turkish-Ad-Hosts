...
- Bu modül en güncel magisk yapısını kullanmaktadır. Yapıya ait dosyaları doğrudan [kendi kaynağının](https://github.com/Zackptg5/MMT-Extended) biraz değiştirilmiş [kopyasından](https://github.com/symbuzzer/MMT-Extended-Next) çekmektedir.  
...
- This module uses the latest magisk build. It pulls the files of the structure directly from a bit modified [fork](https://github.com/symbuzzer/MMT-Extended-Next) of the [its source](https://github.com/Zackptg5/MMT-Extended).  
